<script>
	...
	onMount(() => {
		...
		script.src =
			'https://www.paypal.com/sdk/js?client-id=Aa7ii1FdjWNw9FGl37lbCKzFw1QHxFIU09WPla51pCuKR8-RwUZ-N6SBJkMGzyEA30ByMmjxcMaFocpm&components=buttons,card-fields&enable-funding=venmo';
